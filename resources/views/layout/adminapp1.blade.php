...
<head>
    ...
    <!-- DataTables -->
    <link href="../assetsadmin/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css" />
    <link href="../assetsadmin/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css" rel="stylesheet" type="text/css" />
...
<body data-sidebar="dark" data-layout-mode="light">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="{{ url('admin/') }}" class="logo logo-light">
                            <span class="logo-sm">
                                <h1 style="padding-top: 30px;color:#fff;">RSSOSA</h1>
                            </span>
                            <span class="logo-lg">
                                <h1 style="padding-top: 30px;color:#fff;">RSSOSA</h1>
                            </span>
    ...
    <script src="../assetsadmin/libs/datatables.net/js/jquery.dataTables.min.js"></script>
    <script src="../assetsadmin/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
    <!-- Buttons examples -->
    <script src="../assetsadmin/libs/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script src="../assetsadmin/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
    <script src="../assetsadmin/libs/jszip/jszip.min.js"></script>
    <script src="../assetsadmin/libs/pdfmake/build/pdfmake.min.js"></script>
    <script src="../assetsadmin/libs/pdfmake/build/vfs_fonts.js"></script>
    <script src="../assetsadmin/libs/datatables.net-buttons/js/buttons.html5.min.js"></script>
    <script src="../assetsadmin/libs/datatables.net-buttons/js/buttons.print.min.js"></script>
    <script src="../assetsadmin/libs/datatables.net-buttons/js/buttons.colVis.min.js"></script>

    <!-- Responsive examples -->
    <script src="../assetsadmin/libs/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="../assetsadmin/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>
