            ...
            <nav class="sidebar-nav" data-simplebar>
                <ul id="sidebar-menu" class="sidebar-menu">
                    ...
                    <li class="{{ request()->is('user/dashboard*') ? 'mm-active' : '' }}">
                        <a href="{{ url('user/dashboard') }}" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <img src="../assetsuser/images/icon/element.svg" alt="element">
                            </div>
                            <span class="menu-title">Dashboards</span>
                        </a>
                    </li>
                    <li class="{{ request()->is('user/scholarship*') ? 'mm-active' : '' }}{{ request()->is('user/job*') ? 'mm-active' : '' }}">
                        <a href="#" class="has-arrow box-style d-flex align-items-center">
                            <div class="icon">
                                <span class="bx bx-book-content text-dark" style="font-size: 30px;padding-top:9px;"></span>
                            </div>
                    ...
                    <li class="{{ request()->is('user/forum*') ? 'mm-active' : '' }}">
                        <a href="{{ url('user/forum') }}" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <span class="bx bx-chat text-dark" style="font-size: 30px;padding-top:9px;"></span>
                            </div>
                            <span class="menu-title">Forum</span>
                        </a>
                    </li>
                    <li class="{{ request()->is('user/product*') ? 'mm-active' : '' }}">
                        <a href="{{ url('user/product') }}" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <span class="bx bx-cart text-dark" style="font-size: 30px;padding-top:9px;"></span>
                            </div>
                    ...
                    <li>
                        <a href="#" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <span class="bx bx-money text-dark" style="font-size: 30px;padding-top:9px;"></span>
                            </div>
                            <span class="menu-title">Dues Payment</span>
                        </a>
                    </li>
                    <li class="{{ request()->is('user/notice-board*') ? 'mm-active' : '' }}">
                        <a href="{{ url('user/notice-board') }}" class="box-style d-flex align-items-center">
                            <div class="icon">
                                <span class="bx bx-notepad text-dark" style="font-size: 30px;padding-top:9px;"></span>
                            </div>
