...
@section('title')
Class Set Voting Candidate || ROSSOA
@endsection
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">RSSOSA Class Set Voting Candidate</h4>

                        <div class="page-title-right">
                            <button class="btn btn-success"><a href="{{ url('admin/batch-voting') }}" class="text-white">Go Back to Voting Category</a></button>
                        </div>
                    </div>
                </div>
            </div>
