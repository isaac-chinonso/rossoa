                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ url('admin/save-job') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                ...
                                <div align="right">
                                    ...
                                    <button type="submit" class="btn btn-success waves-effect waves-light">Add Job Opening</button>
                                </div>
                            </form>
